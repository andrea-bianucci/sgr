...
Agli inizi di Intenet, ogni protocollo era associato in maniera biunivoca ad una porta nota, oggi giorno, a parte per alcuni protocolli che per ragioni storiche questa relazione è rimasta valida (es: HTTP via TCP porta 80), in molti altri casi, dovuto anche
...
viaggiano in chiaro, ovvero quelli relativi alla fase di accordo iniziale (**Handshaking**), prelevando da questi pacchetti dei metadati interessanti per le analisi. In particolare nDPI:
